export default {
  ...
  title: 'My grid',
  description:
    'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed, repellendus nobis? Id placeat, adipisci minus dicta, nisi quasi iste nostrum ratione voluptatem error repellat veritatis doloremque quaerat temporibus quidem accusantium.',
  grid: [
    {
      altText: 'Teste 1',
